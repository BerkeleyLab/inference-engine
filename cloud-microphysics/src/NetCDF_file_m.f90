...
module NetCDF_file_m
  ...
  contains
    procedure :: input_2D_integer, input_1D_double, input_4D_real, input_3D_real, input_2D_real, input_2D_double, input_real_scalar
    generic :: input => input_2D_integer, input_1D_double, input_4D_real, input_3D_real, input_2D_real, input_2D_double, input_real_scalar
  end type
  ...
  interface
    ...
    module subroutine input_2D_real(self, varname, values)
      implicit none
      class(NetCDF_file_t), intent(in) :: self
      character(len=*), intent(in) :: varname
      real, intent(out), allocatable :: values(:,:)
